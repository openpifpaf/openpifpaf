...
class CifPanBallCollector(torch.nn.Module):
    def __init__(self, cif_indices):
        super(CifPanBallCollector, self).__init__()
        self.cif_indices = cif_indices
        LOG.debug('cif = %s', cif_indices)
...
class CifPanCentCollector(torch.nn.Module):
    def __init__(self, cif_indices):
        super(CifPanCentCollector, self).__init__()
        self.cif_indices = cif_indices
        LOG.debug('cif = %s', cif_indices)
...
class PanCentCollector(torch.nn.Module):
    def __init__(self, cif_indices):
        super(PanCentCollector, self).__init__()
        self.cif_indices = cif_indices
        LOG.debug('cif = %s', cif_indices)
